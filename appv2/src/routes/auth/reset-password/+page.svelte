...
<svelte:head>
	...
	<meta name="description" content="Choose a new password for your NuBlox account." />
</svelte:head>
...
<main class="recovery-shell">
	<section class="recovery-card">
		...
		{#if invalidToken}
			...
			<p class="footer-copy">
				<a href={resolve('/auth/forgot-password')}>Request a new reset link</a>
			</p>
		{:else}
			<p class="lede">
				Use at least 12 characters. Completing this reset revokes the account's existing NuBlox
				sessions.
			</p>
