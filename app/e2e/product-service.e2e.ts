...
test('F05 governs portfolio, need, idea, investment and lifecycle design', async ({ page }) => {
	...
	await selectOptionMatching(idea.locator('select[name="needPublicId"]'), /NEED-E2E/);
	...
	await selectOptionMatching(businessCase.locator('select[name="ideaPublicId"]'), /IDEA-E2E/);
	await selectOptionMatching(businessCase.locator('select[name="offeringPublicId"]'), /OFFER-E2E/);
	...
	await selectOptionMatching(design.locator('select[name="offeringPublicId"]'), /OFFER-E2E/);
	await selectOptionMatching(design.locator('select[name="businessCasePublicId"]'), /BC-E2E/);
	...
	await selectOptionMatching(review.locator('select[name="designPublicId"]'), /DES-E2E/);
