	...
	<section class="auth-card">
		...
		{#if submitted}
			<div class="notice success" role="status">
				If a NuBlox account exists for <strong>{email}</strong>, a password-reset link has been
				sent. For local development, check the terminal running NuBlox.
			</div>
		...
		{:else}
			<p class="lede">
				Enter your account email. We will send a time-limited link that lets you choose a new
				password.
			</p>
