		...
		<section class="panel">
			...
			{#if data.canManageDraft}
				<form method="POST" action="?/addLine" class="line-form">
					...
					<label>Tax<select name="taxCategoryPublicId" required>{#each data.taxCategories as tax}<option value={tax.publicId}>{tax.name}{tax.ratePercent ? ` (${tax.ratePercent}%)` : ''}</option>{/each}</select></label>
...
<style>
	.breadcrumbs{display:flex;gap:.55rem;align-items:center;color:var(--muted,#667085);font-size:.9rem;margin-bottom:1rem}.breadcrumbs a{color:inherit}.page-heading,.section-heading{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start}.page-heading{margin-bottom:1rem}.page-heading h1,.panel h2{margin:.15rem 0}.eyebrow{text-transform:uppercase;letter-spacing:.08em;font-size:.72rem;font-weight:700;color:var(--muted,#667085);margin:0}.status{font-size:.76rem;text-transform:uppercase;letter-spacing:.05em;border:1px solid var(--border,#d0d5dd);border-radius:999px;padding:.35rem .6rem}.status-issued{background:#ecfdf3;color:#027a48;border-color:#abefc6}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:.65rem;margin-bottom:1rem}.metrics div{border:1px solid var(--border,#d0d5dd);border-radius:11px;padding:.75rem;background:var(--surface,#fff)}.metrics span{display:block;color:var(--muted,#667085);font-size:.76rem}.metrics strong{display:block;margin-top:.25rem}.grid,.stack{display:grid;gap:1rem}.panel{border:1px solid var(--border,#d0d5dd);border-radius:14px;background:var(--surface,#fff);padding:1rem}.form-grid,.line-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem;align-items:end;margin-top:1rem}.form-grid label,.line-form label{display:grid;gap:.3rem;font-size:.86rem;font-weight:600}.form-grid input,.form-grid select,.form-grid textarea,.line-form input,.line-form select{font:inherit;padding:.62rem;border:1px solid var(--border,#d0d5dd);border-radius:8px;background:transparent}.wide{grid-column:1/-1}.one-column{grid-template-columns:1fr}.lines,.rows{display:grid;gap:.6rem;margin-top:.8rem}.line{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:.8rem;align-items:center;border:1px solid var(--border,#e4e7ec);border-radius:10px;padding:.75rem}.line small,.evidence small{display:block;color:var(--muted,#667085);margin-top:.18rem}.line-money{text-align:right}.evidence{padding:.65rem;background:var(--surface-subtle,#f8fafc);border-radius:9px}.evidence p{margin:.4rem 0 0}.muted{color:var(--muted,#667085)}.notice{background:#fffaeb;color:#93370d;padding:.65rem;border-radius:9px}button{font:inherit;font-weight:700;padding:.65rem .85rem;border-radius:9px;border:0;background:#1d2939;color:white;cursor:pointer}.quiet{background:transparent;color:inherit;border:1px solid var(--border,#d0d5dd);padding:.4rem .55rem}.banner{padding:.75rem 1rem;border-radius:9px}.error{color:#b42318;background:#fef3f2}dl{margin:.7rem 0 0}dl div{display:flex;justify-content:space-between;gap:1rem;padding:.35rem 0}dt{color:var(--muted,#667085)}dd{margin:0;text-align:right}@media(min-width:1050px){.grid{grid-template-columns:minmax(0,1.4fr) minmax(300px,.7fr)}}@media(max-width:650px){.form-grid,.line-form{grid-template-columns:1fr}.wide{grid-column:auto}.line{grid-template-columns:1fr}.line-money{text-align:left}}
</style>
