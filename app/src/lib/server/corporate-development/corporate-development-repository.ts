...
export type CorporateDevelopmentStageHistoryRecord =
	Selectable<CorporateDevelopmentOpportunityStageHistory>;
export type CorporateDevelopmentValuationRecord = Selectable<CorporateDevelopmentValuations>;
export type CorporateDevelopmentValuationScenarioRecord =
	Selectable<CorporateDevelopmentValuationScenarios>;
export type CorporateDevelopmentValuationAssumptionRecord =
	Selectable<CorporateDevelopmentValuationAssumptions>;
...
export class CorporateDevelopmentRepository {
	...
	listOpportunities(organisationId: string) {
		return this.db
			.selectFrom('corporate_development_opportunities')
			.selectAll()
	...
	async insertOpportunity(values: Insertable<CorporateDevelopmentOpportunities>) {
		const result = await this.db
			.insertInto('corporate_development_opportunities')
			.values(values)
	...
	async updateOpportunity(
		...
		id: string,
		values: Updateable<CorporateDevelopmentOpportunities>
	) {
		await this.db
			.updateTable('corporate_development_opportunities')
			.set(values)
			.where('organisation_id', '=', organisationId)
			.where('id', '=', id)
			.executeTakeFirstOrThrow();
	...
	listStageHistory(organisationId: string, opportunityId: string) {
		return this.db
			.selectFrom('corporate_development_opportunity_stage_history')
			.selectAll()
			.where('organisation_id', '=', organisationId)
	...
	async insertStageHistory(values: Insertable<CorporateDevelopmentOpportunityStageHistory>) {
		await this.db
			.insertInto('corporate_development_opportunity_stage_history')
			.values(values)
			.executeTakeFirstOrThrow();
	}
	...
	async insertValuation(values: Insertable<CorporateDevelopmentValuations>) {
		const result = await this.db
			.insertInto('corporate_development_valuations')
			.values(values)
			.executeTakeFirstOrThrow();
	...
	async updateValuation(
		organisationId: string,
		id: string,
		values: Updateable<CorporateDevelopmentValuations>
	) {
		await this.db
			.updateTable('corporate_development_valuations')
			.set(values)
			.where('organisation_id', '=', organisationId)
			.where('id', '=', id)
			.executeTakeFirstOrThrow();
	...
	listScenarios(organisationId: string, valuationIds: string[]) {
		if (!valuationIds.length)
			return Promise.resolve([] as CorporateDevelopmentValuationScenarioRecord[]);
		return this.db
			.selectFrom('corporate_development_valuation_scenarios')
			.selectAll()
			.where('organisation_id', '=', organisationId)
			.where('valuation_id', 'in', valuationIds)
	...
	async insertScenario(values: Insertable<CorporateDevelopmentValuationScenarios>) {
		const result = await this.db
			.insertInto('corporate_development_valuation_scenarios')
			.values(values)
			.executeTakeFirstOrThrow();
	...
	listAssumptions(organisationId: string, scenarioIds: string[]) {
		if (!scenarioIds.length)
			return Promise.resolve([] as CorporateDevelopmentValuationAssumptionRecord[]);
		return this.db
			.selectFrom('corporate_development_valuation_assumptions')
			.selectAll()
			.where('organisation_id', '=', organisationId)
			.where('valuation_scenario_id', 'in', scenarioIds)
	...
	async insertAssumption(values: Insertable<CorporateDevelopmentValuationAssumptions>) {
		const result = await this.db
			.insertInto('corporate_development_valuation_assumptions')
			.values(values)
			.executeTakeFirstOrThrow();
