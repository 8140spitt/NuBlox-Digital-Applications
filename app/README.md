...
`ReceivablesControlReportingService` preserves Package 004F historical semantics while adding:
...
See `docs/42-controlled-bad-debt-writeoff-recovery.md`.
...
The exact test totals are recorded after the final documentation-synchronised PR head passes this complete gate.
